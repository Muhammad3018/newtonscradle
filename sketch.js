...
function setup() {
  ...
  pendulum1 = new Pendulum(320,420,"#3366ff");
  pendulum2 = new Pendulum(380,420,"#3366ff");
  pendulum3 = new Pendulum(440,420,"#3366ff");
  pendulum4 = new Pendulum(500,420,"#3366ff");
  pendulum5 = new Pendulum(560,420,"#3366ff");
